...
public class CreateContaReceberValidator : DomainValidator<CriarContaReceberRequest>
{
    public CreateContaReceberValidator()
    {
    ...
    private static bool ValidateRateiosSum(CriarContaReceberRequest request)
    {
...
public class UpdateContaReceberValidator : DomainValidator<AtualizarContaReceberRequest>
{
    public UpdateContaReceberValidator()
    {
        RuleFor(x => x.Id)
            .NotEmpty()
...
public class LiquidarContaReceberValidator : DomainValidator<LiquidarContaReceberRequest>
{
    public LiquidarContaReceberValidator()
    {
