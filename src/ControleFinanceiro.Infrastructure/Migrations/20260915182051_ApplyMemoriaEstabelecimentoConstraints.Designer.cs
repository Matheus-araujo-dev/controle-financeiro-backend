...
namespace ControleFinanceiro.Infrastructure.Migrations
{
    ...
    [Migration("20260915182051_ApplyMemoriaEstabelecimentoConstraints")]
    partial class ApplyMemoriaEstabelecimentoConstraints
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ControleFinanceiro.Domain.Cadastros.Cartoes.Cartao", b =>
                {
                    ...
                    b.Property<Guid?>("FormaPagamentoPadraoFaturaId")
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid?>("RecebedorPadraoFaturaId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("FormaPagamentoPadraoFaturaId");

                    b.HasIndex("RecebedorPadraoFaturaId");
            ...
            modelBuilder.Entity("ControleFinanceiro.Domain.Cadastros.ContasGerenciais.ContaGerencial", b =>
                {
                    ...
                    b.Property<Guid?>("ContaGerencialContrariaId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("ContaGerencialContrariaId");
            ...
            modelBuilder.Entity("ControleFinanceiro.Domain.Cadastros.Pessoas.Pessoa", b =>
                {
                    ...
                    b.Property<Guid?>("ContaGerencialDespesaId")
                        .HasColumnType("uuid");

                    b.Property<Guid?>("ContaGerencialReceitaId")
                        .HasColumnType("uuid");
                    ...
                    b.Property<bool>("EhPagador")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(true);

                    b.Property<bool>("EhRecebedor")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(true);
                    ...
                    b.HasIndex("ContaGerencialDespesaId");
            ...
            modelBuilder.Entity("ControleFinanceiro.Domain.Conciliacao.Conciliacao", b =>
                {
                    ...
                    b.HasIndex("FamiliaId", "FaturaId", "HashArquivo")
                        .IsUnique();
            ...
            modelBuilder.Entity("ControleFinanceiro.Domain.Conciliacao.ItemConciliacao", b =>
                {
                    ...
                    b.Property<Guid?>("ContaPagarVinculadaId")
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("RascunhoJson")
                        .HasColumnType("text");
                    ...
                    b.Property<decimal?>("ValorAnteriorSistema")
                        .HasPrecision(18, 2)
                    ...
                    b.HasIndex("ContaPagarVinculadaId");

                    b.HasIndex("FamiliaId");

                    b.HasIndex("MovimentacaoVinculadaId");

                    b.HasIndex("ConciliacaoId", "ChaveOrigem")
                        .IsUnique();

                    b.HasIndex("ConciliacaoId", "ContaPagarVinculadaId")
                        .IsUnique();
            ...
            modelBuilder.Entity("ControleFinanceiro.Domain.FinanceAI.AlertaDigitalEnviado", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AlertasDigitaisEnviados");
                });
            ...
            modelBuilder.Entity("ControleFinanceiro.Domain.FinanceAI.ConfiguracaoNotificacao", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<bool>("EmailAtivo")
                        .HasColumnType("boolean");

                    b.Property<string>("EmailDestinatario")
                        .HasColumnType("text");

                    b.Property<int>("EmailDiasAntecedencia")
                        .HasColumnType("integer");

                    b.Property<bool>("EmailLimiteCategoria")
                        .HasColumnType("boolean");

                    b.Property<bool>("EmailVencimento")
                        .HasColumnType("boolean");

                    b.Property<Guid>("FamiliaId")
                        .HasColumnType("uuid");

                    b.Property<bool>("PushAtivo")
                        .HasColumnType("boolean");

                    b.Property<int>("PushDiasAntecedencia")
                        .HasColumnType("integer");

                    b.Property<bool>("PushLimiteCategoria")
                        .HasColumnType("boolean");

                    b.Property<bool>("PushVencimento")
                        .HasColumnType("boolean");
                    ...
                    b.ToTable("ConfiguracoesNotificacao");
                });

            modelBuilder.Entity("ControleFinanceiro.Domain.FinanceAI.PushSubscription", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("ControleFinanceiro.Domain.Financeiro.ContaPagar", b =>
                {
                    ...
                    b.Property<Guid?>("GrupoReembolsoId")
                        .HasColumnType("uuid");

                    b.Property<Guid?>("GrupoResponsaveisId")
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("TipoContaVinculada")
                        .HasMaxLength(20)
                        .HasColumnType("character varying(20)");
                    ...
                    b.HasIndex("CartaoId", "StatusContaId")
            ...
            modelBuilder.Entity("ControleFinanceiro.Domain.Financeiro.Investimento", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

                    b.Property<Guid>("ContaBancariaVinculadaId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("ContaBancariaVinculadaId");
            ...
            modelBuilder.Entity("ControleFinanceiro.Domain.Financeiro.Plano", b =>
                {
                    ...
                    b.Property<Guid>("ContaBancariaCaixaId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("ControleFinanceiro.Domain.Cadastros.Cartoes.Cartao", b =>
                {
                    ...
                    b.HasOne("ControleFinanceiro.Domain.Cadastros.FormasPagamento.FormaPagamento", null)
                        .WithMany()
                        .HasForeignKey("FormaPagamentoPadraoFaturaId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("ControleFinanceiro.Domain.Cadastros.Pessoas.Pessoa", null)
                        .WithMany()
                        .HasForeignKey("RecebedorPadraoFaturaId")
                        .OnDelete(DeleteBehavior.Restrict);
                });
            ...
            modelBuilder.Entity("ControleFinanceiro.Domain.Cadastros.ContasGerenciais.ContaGerencial", b =>
                {
                    b.HasOne("ControleFinanceiro.Domain.Cadastros.ContasGerenciais.ContaGerencial", null)
                        .WithMany()
                        .HasForeignKey("ContaGerencialContrariaId")
            ...
            modelBuilder.Entity("ControleFinanceiro.Domain.Cadastros.Pessoas.Pessoa", b =>
                {
                    b.HasOne("ControleFinanceiro.Domain.Cadastros.ContasGerenciais.ContaGerencial", null)
                        .WithMany()
                        .HasForeignKey("ContaGerencialDespesaId")
                        .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity("ControleFinanceiro.Domain.Financeiro.Investimento", b =>
                {
                    b.HasOne("ControleFinanceiro.Domain.Cadastros.ContasBancarias.ContaBancaria", null)
                        .WithMany()
                        .HasForeignKey("ContaBancariaVinculadaId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("ControleFinanceiro.Domain.Financeiro.MovimentacaoFinanceira", b =>
                {
                    ...
                    b.HasOne("ControleFinanceiro.Domain.Financeiro.Transferencia", null)
                        .WithMany()
